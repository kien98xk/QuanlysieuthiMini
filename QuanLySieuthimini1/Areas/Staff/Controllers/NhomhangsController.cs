...
namespace QuanLySieuthimini1.Areas.Staff.Controllers
{
    public class NhomhangsController : Controller
    {
        ...
        // GET: Staff/Nhomhangs/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Staff/Nhomhangs/Create
